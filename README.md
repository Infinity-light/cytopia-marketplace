...
claude /plugin info workflow-kit@cytopia-marketplace
```
...
```bash
# 1. 更新 marketplace 索引
claude /marketplace update cytopia-marketplace

# 2. 重新安装插件（会自动获取最新版本）
claude /install workflow-kit@cytopia-marketplace
```
...
- **Marketplace**: cytopia-marketplace v1.0.0
- **Workflow-Kit**: v2.3.0
